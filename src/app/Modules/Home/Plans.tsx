  ...
  return (
    <div className="Plans_Container flex flex-col justify-center items-center mt-[50px]">
      ...
      <motion.div
        ...
        className="all_plans_Container px-[20px] sm:px-[50px] 2xl:px-40 grid  lg:grid-cols-3 md:grid-cols-2 grid-cols-1 xl:grid-cols-4 w-full mt-6 md:mt-16 gap-[20px]"
      >
