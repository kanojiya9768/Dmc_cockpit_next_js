...
export const FeaturesSection = () => {
  ...
  return (
    <div className="feature_section_Container lg:h-[1000px]">
      ...
      <div className="flex flex-wrap justify-center items-center gap-[20px] xl:gap-[60px] mt-[40px] w-full sm:px-0 px-4">
      ...
      <div className="w-full h-auto relative">
        ...
        <div className="w-[85%] absolute left-2/4 top-[50px] -translate-x-1/2 bg-[#f7f7ff] rounded-[10px] flex md:flex-row flex-col md:gap-0 gap-[40px] justify-between items-center p-[20px]">
