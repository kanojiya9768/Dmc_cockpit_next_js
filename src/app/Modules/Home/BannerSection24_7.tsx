...
export const BannerSection24_7 = () => {
  return (
    <div className="BannerSection24_7_Container w-full h-[300px] mt-[70px]  [background-size:120%] !bg-no-repeat bg-[url('/banner2-30-days-free-triel/background.png')] relative">
      <div className="banner24_7 w-[88%] h-[330px] m-auto rounded-[20px] absolute -top-[70px] left-2/4 -translate-x-1/2 bg-[url('/banner2-30-days-free-triel/blue_banner.png')] bg-cover bg-no-repeat flex">
        <Image
